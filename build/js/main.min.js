...
var _initTabs = require("./modules/init-tabs");
var _initAccordion = require("./modules/init-accordion");
var _feedbackSwiper = require("./modules/feedback-swiper");
var _coachesSwiper = require("./modules/coaches-swiper");
var _faqButtons = require("./modules/faq-buttons");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    _feedbackSwiper.swiperFeedback;
    _coachesSwiper.swiperCoaches;
    (0, _faqButtons.isResizePaddingBottom)();
    (0, _faqButtons.isChangeAccordionButtons)();
    (0, _video.openVideo)();
  });
});
...
},{"./modules/coaches-swiper":3,"./modules/faq-buttons":4,"./modules/feedback-swiper":5,"./modules/form-validate/form":7,"./modules/init-accordion":13,"./modules/init-tabs":14,"./modules/modals/init-modals":15,"./modules/video":18,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
exports.swiperCoaches = void 0;
var swiperCoaches = new Swiper('.coaches__swiper', {
  // Optional parameters
  /* direction: 'vertical',*/
  loop: true,
  /*loopedSlides: 4,*/
...
exports.swiperCoaches = swiperCoaches;
...
exports.isResizePaddingBottom = exports.isChangeAccordionButtons = void 0;
var accordionToggles = document.querySelectorAll('[data-accordion="button"]');
var accordionItems = document.querySelectorAll('[data-accordion="element"]');
var isResizePaddingBottom = function isResizePaddingBottom() {
  accordionItems.forEach(function (element) {
    element.classList.add('is-resize-padding-bottom');
  });
};
exports.isResizePaddingBottom = isResizePaddingBottom;
var isChangeAccordionButtons = function isChangeAccordionButtons() {
...
exports.isChangeAccordionButtons = isChangeAccordionButtons;
...
},{"./accordions":2}],14:[function(require,module,exports){
"use strict";
...
},{"./tabs":17}],15:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":19,"../../utils/scroll-lock":22}],17:[function(require,module,exports){
"use strict";
...
var videoViewPort = document.querySelector('[data-iframe="play"]');
var videoButton = document.querySelector('[data-video-button]');
var videoImage = document.querySelector('[data-image-video]');
var onDocumentKeydown = function onDocumentKeydown() {
  if (isEscapeKey) {
    closeVideo();
  }
};
